...
@Log4j2
public class PostmonProvider extends ZipcodeProvider<PostmonAddress> {
    ...
    @Autowired
    public PostmonProvider(@Qualifier("PostmonApiInfo") ApiInfo apiInfo, ObjectMapper objectMapper) {
